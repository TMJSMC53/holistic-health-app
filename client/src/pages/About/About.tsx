  ...
  return (
    <div className="text-16 my-8 md:text-20 md:mt-12 mx-6 md:mx-10 text-justify font-poppins">
      <p className="mb-4">
        ...
        app is a comprehensive tool designed to help you track various aspects
        of your well-being, including fluid and water intake, sleep patterns,
        meditation practices, and daily notes. More than just a tracker, our app
        is a personalized health companion that keeps you motivated and focused
