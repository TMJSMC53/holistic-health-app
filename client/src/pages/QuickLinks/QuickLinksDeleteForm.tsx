...
const QuickLinksDeleteForm = ({ link }: { link: QuickLinks }) => {
    ...
    <>
      <div>
        <label
          ...
          className="btn bg-transparent border-0 shadow-transparent hover:bg-transparent px-2"
        >
...
export default QuickLinksDeleteForm;
